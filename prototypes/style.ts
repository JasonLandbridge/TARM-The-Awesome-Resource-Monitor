...
export default function applyStyles(defaultGui: any) {
	...
	defaultGui[Styles.CellBaseStyle] = {
		type: 'label_style',
		margin: 0,
		width: 68,
	};
	...
	defaultGui[Styles.CellNumericValueStyle] = {
		type: 'label_style',
		parent: Styles.CellBaseStyle,
	...
	defaultGui[Styles.CellResourceStyle] = {
		type: 'label_style',
		parent: Styles.CellBaseStyle,
